...
export const VDatePickerTransition = createSimpleTransition('scale-transition', 'center center', 'out-in')
...
export default function install (Vue) {
  ...
  Vue.component('v-date-picker-transition', VDatePickerTransition)
