...
test('VDatePicker.js', ({ mount, compileToFunctions }) => {
  it('should display the correct date in title and header', () => {
    ...
    const title = wrapper.find('.v-date-picker-title__date')
    const header = wrapper.find('.v-date-picker-header__value strong')
  ...
  it('should emit input event on date click', async () => {
    ...
    wrapper.find('.v-date-picker-table--date tbody tr+tr td:first-child button').trigger('click')
  ...
  it('should not emit input event on month click if date is not allowed', async () => {
    ...
    wrapper.find('.v-date-picker-table--month button').trigger('click')
  ...
  it('should be scrollable', async () => {
    ...
    wrapper.find('.v-date-picker-table--date').trigger('wheel')
  ...
  it('should change tableDate on touch', async () => {
    ...
    const table = wrapper.find('.v-date-picker-table--date')
  ...
  it('should match snapshot with title/header formatting functions', () => {
    ...
    expect(wrapper.find('.v-date-picker-title__date').text()).toBe('(2005-11-01)')
    expect(wrapper.find('.v-date-picker-header__value').text()).toBe('(2005-11)')
  })
  ...
  it('should match snapshot with year icon', () => {
    ...
    expect(wrapper.find('.v-picker__title').html()).toMatchSnapshot()
  })
  ...
  it('should match change month when clicked on header arrow buttons', () => {
    ...
    const [leftButton, rightButton] = wrapper.findAll('.v-date-picker-header button').wrappers
  ...
  it('should match change active picker when clicked on month button', () => {
    ...
    const button = wrapper.find('.v-date-picker-header strong')
  ...
  it('should use prev and next icons', () => {
    ...
    expect(icons.at(0).text()).toBe('block')
    expect(icons.at(1).text()).toBe('check')
  })
