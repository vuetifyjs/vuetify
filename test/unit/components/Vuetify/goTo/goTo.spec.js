import Vue from 'vue'
import goTo from '@/components/Vuetify/goTo'
...
test('goTo.js', ({ mount }) => {
  ...
  it('should throw error when container element is not found', async () => {
    await expect(goTo(0, { container: '#thisContainerDoesNotExist' }))
      .rejects
