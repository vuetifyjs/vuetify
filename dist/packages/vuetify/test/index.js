...
export function test(name, cb) {
    ...
    */
    ...
    describe(name, function () { return cb({
...
export function touch(element) {
    var createTrigger = function (eventName) { return function (clientX, clientY) {
...
export var resizeWindow = function (width, height) {
    if (width === void 0) { width = global.innerWidth; }
    if (height === void 0) { height = global.innerHeight; }
