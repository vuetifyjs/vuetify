...
var inputSlots = ['append', 'prepend', 'default'];
var textFieldSlots = __spread(inputSlots, ['append-outer', 'prepend-inner', 'label']);
var selectSlots = __spread(textFieldSlots, ['append-item', 'prepend-item']);
var VSelect = {
    props: [
        {
            name: 'filter',
    ...
    ], inputEvents, textEvents).concat(validatableEvents)
};
var VTreeviewScopedProps = {
    item: 'any',
    leaf: 'boolean',
    selected: 'boolean',
...
module.exports = {
    ...
    'v-input': {
        events: __spread(inputEvents),
        slots: __spread(inputSlots)
    },
    'v-layout': {
        props: [
            {
    ...
    'v-slider': {
        ...
        ], inputEvents).concat(validatableEvents)
    },
    'v-range-slider': {
        events: __spread([
            {
