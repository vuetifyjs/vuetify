    ...
    methods: {
        ...
        genIcon: function (direction) {
            ...
            return this.$createElement(VIcon, {
                ...
                on: {
                    click: function () { return _this.scrollTo(direction); }
                }
            }, this[direction + "Icon"]);
        },
        genItems: function (items, item) {
            if (items.length > 0)
                return items;
            if (!item.length)
                return null;
        ...
        genTransition: function (direction) {
            return this.$createElement('transition', {
                props: { name: 'fade-transition' }
            }, [this.genIcon(direction)]);
        },
        genWrapper: function (items) {
            var _this = this;
            return this.$createElement('div', {
                ...
                directives: [{
                        name: 'touch',
                        value: {
                            start: function (e) { return _this.overflowCheck(e, _this.onTouchStart); },
                            move: function (e) { return _this.overflowCheck(e, _this.onTouchMove); },
                            end: function (e) { return _this.overflowCheck(e, _this.onTouchEnd); }
                        }
                    }]
            }, [items]);
        },
        genSlider: function (items) {
            if (!items.length) {
