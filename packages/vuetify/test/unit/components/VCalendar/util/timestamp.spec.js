...
test('VCalendar/util/timestamp.ts', ({ mount }) => {
  ...
  it('should create native locale formatter', () => {
    expect(createNativeLocaleFormatter("en-US", () => {})(parseTimestamp("2019-02-07"))).toBe('2/6/2019');
    expect(createNativeLocaleFormatter("en-UK", () => {})(parseTimestamp("2019-02-07"))).toBe('2/6/2019');
