...
<<<<<<< HEAD:packages/vuetify/test/unit/components/VCalendar/util/timestamp.spec.js
...
=======
    ...
    expect(createIntervalList(parseTimestamp('2019-02-08'), 1, 15, 10)).toMatchSnapshot()
    expect(createIntervalList(parseTimestamp('2019-02-08'), 2, 5, 2)).toMatchSnapshot()
>>>>>>> next:packages/vuetify/src/components/VCalendar/util/__tests__/timestamp.spec.ts
  })
