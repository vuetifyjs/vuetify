  ...
  inputs: [
    {
      ...
      max: 255,
      step: 1,
      getValue: (c: RGB) => c?.r ? Math.round(c.r) : '',
    ...
    },
    {
      ...
      max: 255,
      step: 1,
      getValue: (c: RGB) => c?.g ? Math.round(c.g) : '',
    ...
    },
    {
      ...
      max: 255,
      step: 1,
      getValue: (c: RGB) => c?.b ? Math.round(c.b) : '',
    ...
    },
    {
      ...
      max: 1,
      step: 0.01,
      getValue: (c: RGB) => c?.a ? Math.round(c.a * 100) / 100 : '',
  ...
  inputs: [
    {
      ...
      max: 360,
      step: 1,
      getValue: (c: HSL) => c?.h ? Math.round(c.h) : '',
    ...
    },
    {
      ...
      max: 1,
      step: 0.01,
      getValue: (c: HSL) => c?.s ? Math.round(c.s * 100) / 100 : '',
    ...
    },
    {
      ...
      max: 1,
      step: 0.01,
      getValue: (c: HSL) => c?.l ? Math.round(c.l * 100) / 100 : '',
    ...
    },
    {
      ...
      max: 1,
      step: 0.01,
      getValue: (c: HSL) => c?.a ? Math.round(c.a * 100) / 100 : '',
...
const hex = {
  ...
  inputs: [
    {
      label: 'HEX',
      getValue: (c: string) => c ? c.slice(0, 7) : '',
      getColor: (c: string, v: string) => v,
    },
  ],
}
