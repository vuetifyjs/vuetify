...
describe('VDataIterator', () => {
  it('should render items in the default slot', async () => {
    ...
    await expect.element(listItems[0]).toMatchTextContent('Frozen Yogurt - 159 calories')
    await expect.element(listItems[4]).toMatchTextContent('Gingerbread - 356 calories')
  })
})
