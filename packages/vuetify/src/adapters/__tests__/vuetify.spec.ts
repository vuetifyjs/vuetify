...
describe('vuetify date adapter', () => {
  ...
  it('should format dates', () => {
    ...
    expect(instance.format(new Date(2000, 0, 1), 'fullDateWithWeekday')).toEqual('Saturday, January 1, 2000')

    instance = new VuetifyDateAdapter('sv-SE')

    expect(instance.format(new Date(2000, 0, 1), 'fullDateWithWeekday')).toEqual('lördag 1 januari 2000')
  })
})
