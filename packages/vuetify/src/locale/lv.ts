export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Nav atlasīta neviena rinda.',
      rowNotSelected: '{0}. rinda nav atlasīta.',
      rowSelected: '{0}. rinda ir atlasīta.',
      allRowsSelected: 'Visas rindas ir atlasītas.',
      someRowsSelected: 'Dažas rindas ir atlasītas.',
    },
    sortBy: 'Kārtot pēc',
  },
  dataFooter: {
