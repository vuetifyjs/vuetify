export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Nobena vrstica ni izbrana.',
      rowNotSelected: 'Vrstica {0} ni izbrana.',
      rowSelected: 'Izbrana je vrstica {0}.',
      allRowsSelected: 'Vse vrstice so izbrane.',
      someRowsSelected: 'Izbranih je nekaj vrstic.',
    },
    sortBy: 'Razvrsti po',
  },
  dataFooter: {
