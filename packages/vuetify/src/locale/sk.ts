export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Nie je vybratý žiadny riadok.',
      rowNotSelected: 'Riadok {0} nie je vybratý.',
      rowSelected: 'Riadok {0} je vybratý.',
      allRowsSelected: 'Všetky riadky sú vybraté.',
      someRowsSelected: 'Niektoré riadky sú vybraté.',
    },
