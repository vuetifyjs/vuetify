export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Hiçbir satır seçilmedi.',
      rowNotSelected: '{0}. Satır seçilmedi.',
      rowSelected: '{0}. satır seçildi.',
      allRowsSelected: 'Tüm satırlar seçili.',
      someRowsSelected: 'Bazı satırlar seçildi.',
    },
    sortBy: 'Sırala',
  },
  dataFooter: {
