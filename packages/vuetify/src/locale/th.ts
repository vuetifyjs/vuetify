export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'ไม่มีการเลือกแถว',
      rowNotSelected: 'แถวที่ {0} ไม่ถูกเลือก',
      rowSelected: 'เลือกแถวที่ {0}',
      allRowsSelected: 'เลือกแถวทั้งหมดแล้ว',
      someRowsSelected: 'เลือกบางแถวแล้ว',
    },
    sortBy: 'เรียงตาม',
  },
  dataFooter: {
