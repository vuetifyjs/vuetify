export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Жоден рядок не вибрано.',
      rowNotSelected: 'Рядок {0} не вибрано.',
      rowSelected: 'Вибрано рядок {0}.',
      allRowsSelected: 'Усі рядки вибрано.',
      someRowsSelected: 'Деякі рядки вибрано.',
    },
