export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Nijedan red nije izabran.',
      rowNotSelected: 'Red {0} nije izabran',
      rowSelected: 'Red {0} je izabran',
      allRowsSelected: 'Svi redovi su izabrani.',
      someRowsSelected: 'Neki redovi su izabrani.',
    },
    sortBy: 'Sortiraj po',
  },
  dataFooter: {
