export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Er is geen rij geselecteerd.',
      rowNotSelected: 'Rij {0} is niet geselecteerd',
      rowSelected: 'Rij {0} is geselecteerd',
      allRowsSelected: 'Alle rijen zijn geselecteerd.',
      someRowsSelected: 'Sommige rijen zijn geselecteerd.',
    },
    sortBy: 'Sorteer op',
  },
  dataFooter: {
