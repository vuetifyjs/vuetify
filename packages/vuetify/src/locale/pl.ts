export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Nie wybrano żadnego wiersza.',
      rowNotSelected: 'Wiersz {0} nie jest zaznaczony.',
      rowSelected: 'Zaznaczony jest wiersz {0}.',
      allRowsSelected: 'Zaznaczono wszystkie wiersze.',
      someRowsSelected: 'Niektóre wiersze zostały zaznaczone.',
    },
