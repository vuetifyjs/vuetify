export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Ниједан ред није изабран.',
      rowNotSelected: 'Ред {0} није изабран',
      rowSelected: 'Ред {0} је изабран',
      allRowsSelected: 'Сви редови су изабрани.',
      someRowsSelected: 'Неки редови су изабрани.',
    },
    sortBy: 'Сортирај по',
  },
  dataFooter: {
