export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Niciun rând nu este selectat.',
      rowNotSelected: 'Rândul {0} nu este selectat.',
      rowSelected: 'Rândul 1 este selectat.',
      allRowsSelected: 'Toate rândurile sunt selectate.',
      someRowsSelected: 'Unele rânduri sunt selectate.',
    },
    sortBy: 'Sortați după',
  },
  dataFooter: {
