export default {
  ...
  dataTable: {
    ...
    ariaLabel: {
      ...
      noRowSelected: 'Không có hàng nào được chọn.',
      rowNotSelected: 'Hàng {0} không được chọn.',
      rowSelected: 'Hàng {0} được chọn.',
      allRowsSelected: 'Tất cả các hàng đều được chọn.',
      someRowsSelected: 'Một số hàng đã được chọn.',
    },
    sortBy: 'Sắp xếp',
  },
  dataFooter: {
