...
describe('easing-patterns.ts', () => {
  it('should work', () => {
    ...
    expect(easingPatterns.easeInOutQuad(.1)).toBe(0.020000000000000004)
    ...
    expect(easingPatterns.easeInOutCubic(.1)).toBe(0.004000000000000001)
    ...
    expect(easingPatterns.easeInOutQuart(.1)).toBe(0.0008000000000000003)
    ...
    expect(easingPatterns.easeInOutQuint(.1)).toBe(0.00016000000000000007)
  })
})
