          ...
          >
            <VBtn
              ...
              class={{
                ...
                'v-time-picker-title__time--with-ampm__btn': props.ampm,
            ...
            <span class={[
              'v-time-picker-title__time__separator',
              { 'v-time-picker-title--with-seconds__time__separator': props.useSeconds },
            ]}
            >:</span>
            <VBtn
              variant="tonal"
