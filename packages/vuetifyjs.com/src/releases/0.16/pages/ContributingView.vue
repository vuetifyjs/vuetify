    ...
    section#reporting-issues
      ...
      section-text
        ul.browser-list
          ...
          li If reproducible, please provide a simple <a href="https://template.vuetifyjs.com" target="_blank" rel="noopener">codepen</a> or repository that can be cloned to produce the expected behavior.
