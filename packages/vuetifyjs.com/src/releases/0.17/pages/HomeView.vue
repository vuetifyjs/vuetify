<template lang="pug">
  #home-view(v-scroll="onScroll")
    v-toolbar(fixed :class="[toolbar ? 'toolbar--home' : 'hidden']" app).white.text-xs-center
      img(src="/doc-images/header-logo.svg" height="38px")
      v-spacer
      v-toolbar-items
        v-btn(
          flat
      ...
      v-container(grid-list-xl)
        v-layout(row wrap)
          v-flex(xs12 md4).text-xs-center
            img(src="/doc-images/logo.svg").logo
      ...
      v-card(tile flat color="primary" dark)
        v-card-text
          ...
          v-btn(
            ...
            class="primary--text"
            light
            href="https://next.vuetifyjs.com/en/store"
            target="_blank"
            large
          ).ml-4 Take me there!
            ...
            v-card-text.py-5
              v-layout(row wrap)
                v-flex(xs12 md4).text-xs-center.my-3
                  img(src="/doc-images/feature1.svg")
                ...
                v-flex(xs12 md4).text-xs-center.my-3
                  img(src="/doc-images/feature2.svg")
                ...
                v-flex(xs12 md4).text-xs-center.my-3
                  img(src="/doc-images/feature3.svg")
                ...
                v-layout(row wrap).text-xs-center
                  ...
                  v-flex(xs12 sm3 offset-sm3)
                    a(
                      ...
                      img(src="/doc-images/patreon.png" width="125px")
                  v-flex(xs12 sm3)
                    a(
                      ...
                      img(src="/doc-images/paypal.png" width="125px")

      section#footer-hero.mb-0
        v-container
          v-layout(row wrap)
            v-flex(xs12 md8 lg10)
              img(src="/doc-images/logo.svg" height="90px")
        ...
        sponsors: [
          {
            ...
            src: '/doc-images/backers/lmax-exchange.png'
          },
          {
            title: 'intygrate',
            href: 'http://intygrate.com/?ref=vuetifyjs.com',
            src: '/doc-images/backers/intygrate.png'
          },
          {
            title: 'BrowserStack',
            href: 'https://www.browserstack.com/',
            src: '/doc-images/browser-stack.svg'
          },
          {
            title: 'Cloudflare',
            href: 'https://www.cloudflare.com/',
            src: '/doc-images/cloudflare.svg'
          }
        ],
        toolbar: false
      }
