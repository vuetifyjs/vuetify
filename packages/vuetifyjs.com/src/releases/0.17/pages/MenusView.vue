      ...
      return {
        doc: {
          ...
          examples: [
            ...
            { header: 'Custom transitions', file: 'menus/custom-transition', desc: `Vuetify comes with 3 standard transitions, <strong>scale</strong>, <strong>slide-x</strong> and <strong>slide-y</strong>. You can also create your own and pass it as the transition argument. For an example of how the stock transitions are constructed, visit <a href="https://github.com/vuetifyjs/vuetify/blob/master/packages/vuetify/src/util/helpers.ts#L31" target="_blank" rel="noopener">here</a>.` },
            { header: 'Popover menu', file: 'menus/popover', desc: 'A menu can be configured to be static when opened, allowing it to function as a popover. This can be useful when there are multiple interactive items within the menu contents.' }
          ],
          props: {
            'v-menu': {
