      ...
      section#font-weights
        v-card(
          ...
          div(
            ...
            div(:class="`${weight[1]} my-2 display-2`") {{ weight[0] }}
            kbd .{{ weight[1] }}
          div(
  ...
  export default {
    data: () => ({
      ...
      weights: [
        ...
        ['Roboto Light', 'font-weight-light', '300'],
      ...
      italics: [
        ['Roboto Thin Italic', 'font-weight-thin', '100'],
        ['Roboto Light Italic', 'font-weight-light', '300'],
