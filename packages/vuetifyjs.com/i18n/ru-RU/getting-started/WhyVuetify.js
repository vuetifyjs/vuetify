  ...
  philosophies: [
    {
      ...
      caption: `Vuetify строится с нуля до семантического. Простота в освоении, простота запоминания и т. Д. Это означает, что независимо от того, разрабатываете ли вы собственное приложение или адаптируете под нового разработчика, компоненты и свойства Vuetify _write-as-you-speak_ делают разработку легкой.`
    },
    {
      img: '/static/vuetify_sizes.svg',
      title: 'Непрерывные обновления',
      caption: `Vuetify имеет последовательный цикл обновления, позволяющий чаще выполнять исправления ошибок и улучшения. Команда разработчиков стремится предоставить вам лучший опыт, который у вас есть.`
    },
    {
      img: '/static/vuetify_cli.svg',
      title: 'Удивительная поддержка',
      caption: `Когда вы сталкиваетесь с проблемой, вам нужна помощь немедленно. Vuetify предлагает поддержку чата в нашем растущем сообществе Discord.`
    }
  ],
  whyText: [
    'Выбор структуры может быть сложной задачей, и я даже не говорю о компонентах. Вы прибыли в Vue, и теперь пришло время начать творить следующую замечательную идею. Есть много вариантов выбора, и все говорят, что они великолепны. Итак, вы должны решить, каковы мои показатели успеха?',
    'Это был я почти год назад. Было много **наборов инструментов UI** на выбор, но ни у кого из них не было всего, что мне было нужно ... да, вы уже это слышали. Часто достаточно, но это - причина индивидуальных попыток создать продукты, которые заполняют пробелы, и именно поэтому я начал работать над Vuetify.',
