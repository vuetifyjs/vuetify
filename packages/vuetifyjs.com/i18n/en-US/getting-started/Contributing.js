export default {
  ...
  issue2: 'For general questions, please join the <a href="https://chat.vuetifyjs.com" target="_blank" rel="noopener">community</a>.',
  ...
  issue5: 'If reproducible, please provide a simple <a href="https://template.vuetifyjs.com" target="_blank" rel="noopener">codepen</a> or repository that can be cloned to produce the expected behavior.',
  pullRequestsHeader: 'Pull requests',
  pullRequest1: 'All PR\'s should be made to the <code>dev</code> branch of Vuetify.',
  ...
  localDevText2: 'After cloned, use your cli to <kbd>cd vuetify</kbd>. Once in the directory, you will need to create a new file in the <kbd>dev</kbd> directory called <code>Playground.vue</code>. An example has been provided, <code>Playground.example.vue</code>, which you can rename. Keep in mind, this file is not tracked by version control. Once copied, go back to your cli and run:',
  localDevText3: 'This will start a local node server located at <a href="http://localhost:8080">http://localhost:8080</a>. Now from your code editor you can easily load components and test whatever you want at lightning speed!'
}
