export default {
  ...
  defaultHeader: 'Default application markup',
  defaultText: `This is an example of the default application markup for Vuetify. You can place your layout elements anywhere, as long as you designate them with the <strong>app</strong> property. The key component in all of this is <code>v-content</code>. This will be dynamically sized depending upon the structure of your designated <strong>app</strong> components. This allows you to create extremely customed solutions.`,
  ...
  layoutsHeader: 'Layouts',
  layoutsText: 'Below is only a <em>few</em> of the many possible layouts with Vuetify. Each one contains a link to the page markup on Github.'
}