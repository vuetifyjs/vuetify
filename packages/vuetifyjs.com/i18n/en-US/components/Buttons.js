export default {
  header: 'Button',
  headerText: 'The <code>v-btn</code> component replaces the standard html button with a material design theme and a multitude of options. Any color helper class can be used to alter the background or text color.',
  components: ['v-btn'],
  examples: [{
    usage: {
      header: 'Usage',
