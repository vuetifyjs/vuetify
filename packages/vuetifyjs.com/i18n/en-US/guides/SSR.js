export default {
  header: 'Overview',
  headerText: 'This overview is designed to help you become fluent in <strong>Vuetify\'s</strong> Vue SSR Template. If you have not already installed the <code>webpack-ssr</code> template, please do so <router-link to="/vuetify/quick-start">in the Quick start</router-link>.',
  ...
  routingText2: 'These routes can be accessed by creating a link to the specified path, or by using Vue Router\'s <code>&lt;router-link&gt;</code> component. For more information, review the official Vue Router <a href="https://router.vuejs.org/en/" target="_blank" rel="noopener">documentation</a>. The default function assumes you are placing views in the <kbd>/pages</kbd> folder containing <strong>View</strong> on the end of the file. Example <code>HomeView.vue</code>.',
  ...
  stateControlText3: 'For more information on State Control and Vuex, view the official <a href="https://vuex.vuejs.org/en/intro.html" target="_blank" rel="noopener">documentation</a>.',
  stateControlText4: 'Vuetify integrates into Vuex to allow for easy debugging and access to stored properties. You can also use watchers to hook into store states and react when they change. More information can be found <a href="https://vuejs.org/v2/guide/reactivity.html" target="_blank" rel="noopener">here</a>.',
  ...
  webAppSupportText: 'Vuetify SSR has support for native Web Applications on smart phones. Also known as progressive web apps, your websites can be saved on the homescreen of a device, allowing it to be usable offline and receive push notifications. For more information on Web App Manifest\'s, navigate to the <a href="https://developer.mozilla.org/en-US/docs/Web/Manifest" target="_blank" rel="noopener">Mozilla Developer Network</a>. To see a live example, add the Vuetify documentation on your mobile device\'s homescreen.',
  toc: [
    {
      text: 'Overview',
      href: 'introduction'
