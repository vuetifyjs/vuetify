export default {
  ...
  activeClass: `Class bound when component is active. <strong class="red--text">warning</strong> Depending upon the component, this could cause side effects. If you need to add a custom class on top of a default, just do <code>active-class="default-class your-class"</code>`,
  ...
  clearable: 'Add input clear functionality, default icon is Material Icons <strong>clear</strong>',
  ...
  errorMessages: 'Puts the input in an error state and passes through custom error messsages. Will be combined with any validations that occur from the <strong>rules</strong> prop. This field will not trigger validation',
