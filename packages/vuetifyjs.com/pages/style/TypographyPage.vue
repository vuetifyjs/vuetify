<template lang="pug">
  text-page(v-bind:data="$data" id="typography-page")
    section#examples
      section-heading(value="Style.Typography.examplesHeader")
...
<script>
  export default {
    ...
    data: () => ({
      header: 'Style.Typography.header',
      headerText: 'Style.Typography.headerText'
    })
  }
</script>
