export default {
  ...
  examples: [{
    standard: {
      ...
      desc: 'Аватара имеет динамический размер, который можно масштабировать для любой ситуации. Для отображения аватара без скругления углов доступна вариация **tile**.'
    },
    advanced: {
