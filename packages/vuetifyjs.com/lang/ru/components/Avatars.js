export default {
  header: 'Avatar',
  headerText: 'Компонент `v-avatar` используется для управления размером и границей отзывчивых изображений, которые обычно используются для отображения изображений профиля.',
  components: ['v-avatar'],
  examples: [{
    standard: {
