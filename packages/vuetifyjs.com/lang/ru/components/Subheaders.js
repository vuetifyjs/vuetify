export default {
  header: 'Subheaders',
  headerText: 'Компонент `v-subheader` используется для выделения разделов списков.',
  components: ['v-subheader'],
  examples: [{
    list: {
      header: '',
      desc: 'Подзаголовки отлично работают со списками для описания нижеприведенной информации.'
    },
    grid: {
