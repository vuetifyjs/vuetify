export default {
  ...
  examples: [{
    ...
    horizontal: {
      ...
      desc: 'Используя `v-flex`, вы можете создавать настраиваемые горизонтальные карты. Используйте свойство `contain`, чтобы сжать `v-card-media`, чтобы поместиться внутри контейнера вместо покрытия.'
    },
    grids: {
      header: 'Grids',
  ...
  props: {
    ...
    tile: 'Поверните карту в плитку, удалив радиус обводки'
  }
}
