export default {
  ...
  examples: [{
    ...
    options: {
      ...
      desc: 'Для более точного настроенного подхода вы можете назначить цель для привязки прослушивателя событий прокрутки.',
      uninverted: true
    }
  }],
  params: [{
    'v-scroll': [
      ...
      },
      {
        ...
        type: 'String',
        default: 'null',
        desc: 'Элемент DOM для привязки прослушивателя событий прокрутки'
      },
      {
        name: 'debounce',
        type: 'Object',
