    ...
    <v-layout column>
      ...
      <v-flex>
        ...
        <v-layout
          ...
          <span class="group pa-2 teal">
            <v-icon
              medium
              dark>mdi-folder-open</v-icon>
            <v-icon
              medium
              dark>mdi-widgets</v-icon>
            <v-icon
              medium
              dark>mdi-gavel</v-icon>
          </span>
        </v-layout>
      ...
      <v-flex>
        <v-layout
          ...
          <span class="group pa-2">
            <v-icon color="teal">mdi-folder-open</v-icon>
            <v-icon color="teal">mdi-widgets</v-icon>
        ...
        <v-layout
          ...
          <span class="group pa-2">
            <v-icon
              color="primary"
              medium>mdi-home</v-icon>
            <v-icon
              color="primary"
              medium>mdi-calendar</v-icon>
            <v-icon
              color="primary"
              medium>mdi-information</v-icon>
          </span>

          <span class="group pa-2">
            <v-icon
              medium
              color="teal">mdi-folder-open</v-icon>
            <v-icon
              medium
              color="teal">mdi-widgets</v-icon>
            <v-icon
              medium
              color="teal">mdi-gavel</v-icon>
          </span>
        </v-layout>
        ...
        <v-layout
          ...
          <span class="group pa-2">
            <v-icon
              color="primary"
              large>mdi-home</v-icon>
            <v-icon
              color="primary"
              large>mdi-calendar</v-icon>
            <v-icon
              color="primary"
              large>mdi-information</v-icon>
          </span>
        ...
        <v-layout justify-space-around>
          <span class="group pa-2">
            <v-icon
              color="primary"
              x-large>mdi-home</v-icon>
            <v-icon
              color="primary"
              x-large>mdi-calendar</v-icon>
            <v-icon
              color="primary"
              x-large>mdi-information</v-icon>
          </span>
