  ...
  export default {
    computed: {
      ...
      contributionLanguageLink () {
        ...
        return `https://github.com/vuetifyjs/vuetify/tree/stable/packages/docs/src/lang/${this.params.lang}/${file}`
      },
      contributionPageLink () {
        const file = `${this.params.namespace}/${this.page}.json`
        return `https://github.com/vuetifyjs/vuetify/tree/stable/packages/docs/src/data/pages/${file}`
      }
    },
