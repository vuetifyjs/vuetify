...
<alert type="info">
  ...
  L'objet options que vous transmettez comme second argument à `Vue.use` peut également inclure une propriété _components_, _directives_ et _transitions_.
