...
Les icônes sont présentées dans deux thèmes (lumière et foncé), et cinq tailles différentes (x-small, small, medium (par défaut), grandes et x-large).
...
En utilisant les utilitaires de couleur, vous pouvez changer la couleur d'une icône à partir des thèmes sombres et clairs standards.
...
Les icônes peuvent être utilisées à l'intérieur des boutons pour accentuer l'action.
