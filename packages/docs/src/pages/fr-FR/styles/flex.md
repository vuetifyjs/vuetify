...
Contrôlez la mise en place de conteneurs flex avec alignement, justification et plus avec les utilitaires flexbox réactifs.
...
<alert type="info">
  ...
  Lorsque vous utilisez flex align avec IE11, vous devrez définir une `height` de façon explicite car `min-height` ne suffira pas et ne causera pas de résultats indésirables.
