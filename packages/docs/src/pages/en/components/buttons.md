...
| **flat** | `true` |
| **size** | provided by `v-btn-group` (requires [v3.13.0](/getting-started/release-notes/?version=v3.13.0)) |
...
::: info
This feature requires [v3.13.0](/getting-started/release-notes/?version=v3.13.0)
:::
