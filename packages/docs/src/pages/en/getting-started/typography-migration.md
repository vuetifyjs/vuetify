...
|-------------------|----------|-----------------------|----------|----------------------------------------------------------|
| `text-h1`         | 96px     | `text-display-large`  | 57px     | ⚠️ Significantly smaller; consider custom size           |
| `text-h2`         | 60px     | `text-display-medium` | 45px     | ⚠️ Noticeably smaller                                    |
| `text-h3`         | 48px     | `text-display-small`  | 36px     | ⚠️ Noticeably smaller                                    |
| `text-h4`         | 34px     | `text-headline-large` | 32px     | ✓ Very close match                                       |
| `text-h5`         | 24px     | `text-headline-small` | 24px     | ✓ Exact match                                            |
| `text-h6`         | 20px     | `text-title-large`    | 22px     | Close match (or `text-headline-small` at 24px)           |
| `text-subtitle-1` | 16px     | `text-body-large`     | 16px     | ✓ Exact match (or `text-title-medium` for 500 weight)    |
...
| `text-button`     | 14px     | `text-label-large`    | 14px     | ✓ Exact match (no uppercase by default)                  |
