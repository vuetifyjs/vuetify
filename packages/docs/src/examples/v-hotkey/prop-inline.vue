        ...
        <v-card>
          <template v-slot:text>
            ...
            <div class="d-flex flex-column ga-4">
              <div>
                <h4 class="text-body-large mb-2">Standard Display (Block-level)</h4>
              ...
              <div>
                <h4 class="text-body-large mb-2">Inline Display (Text-integrated)</h4>
                <div class="pa-4 border rounded" style="line-height: 1.7;">
                  <h4 class="text-title-large mb-3">Getting Started with Code Editor</h4>
